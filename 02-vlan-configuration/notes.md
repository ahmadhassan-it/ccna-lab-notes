...
## Overview
Two-stage VLAN lab progression: Part 1 covers basic VLAN creation and 
isolation on a single switch. Part 2 extends this to multi-switch trunking 
and inter-VLAN routing via Router on a Stick (ROAS), including native VLAN 
hardening and trunk security restrictions.
